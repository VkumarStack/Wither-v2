...
//POST new post 
// Request body should contain: user and text
...
// current time as the date and the author being set to the user passed in the request body.
...
//PUT like/dislike
// Request body should contain: user, boolean representing whether the post is liked or disliked
